import { ISharedUploadConf } from '../ext/fieldTypes/shared';
/**
 ...
 * been uploaded
 */
export declare function upload(editor: any, conf: ISharedUploadConf, files: any, progressCallback: any, completeCallback: any): void;
/**
